...
<<<<<<< HEAD
chrome_driver = webdriver.Chrome('/Users/Downloads/chromedriver',chrome_options=options)
=======
chrome_driver = webdriver.Chrome('/Users/chromedriver',chrome_options=options)
...
<<<<<<< HEAD
chrome_driver.find_element_by_name('email').send_keys('@gmail.com')
chrome_driver.find_element_by_name('password').send_keys('?')
=======
chrome_driver.find_element_by_name('email').send_keys('#@gmail.com')
chrome_driver.find_element_by_name('password').send_keys('#?')
>>>>>>> cdb98408951f672c4a9cd582109ddeabd3ecac92
